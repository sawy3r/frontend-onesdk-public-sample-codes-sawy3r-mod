...
const SmartUI = () => {
  ...
  const initOneSDK = async () => {
    ...
    const ff_config_object = {
      ...
      // 6. Monitor results
      let smartui_config = 'passport' //smartuiconfig=passport
      console.log(smartui_config) //passport
      const form = oneSDKInstance.component("form", config_table[smartui_config]);
      ...
      form.mount("#form-container-smartui");
  }
  ...
  return (
    ...
    <div class="min-w-[100vw] h-[85vh]" id='form-container-smartui'></div>
    </>
  )
}
