...
watchEffect(async () => {
	...
	// 4. Set recipe
	// oneSdk.individual().setProfileType('full');

	// 5. Initialise device module
	...
	// oneSdk.individual().setPhoneNumber("+61-0822082577");
	// oneSdk.individual().setEmail("admin@riskybusiness.com");
